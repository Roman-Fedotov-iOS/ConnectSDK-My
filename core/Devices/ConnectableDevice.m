...
- (void)presentPairingAlertForService:(DeviceService *)service pairingType:(DeviceServicePairingType)pairingType
{
    NSString *title = @"Pairing Required";
    NSString *message = @"Please enter the pairing code displayed on your device.";
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
     ...
     //   [service sendPairingKey:pairingCode];
    }];
